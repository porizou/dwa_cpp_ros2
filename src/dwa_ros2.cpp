...
namespace dwa_ros2
{
    ...
    void DWA::initParameter(void)
    {
        ...
        // Declare obstacle cost gain parameter0.2
    ...
    double DWA::calcGoalCost(std::vector<State> trajectory)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Goal Cost: %lf", cost);
        return cost;
    }
    ...
    double DWA::calcSpeedCost(std::vector<State> trajectory)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Speed Cost: %lf", cost);
        return cost;
    }
    ...
    void DWA::dwaControl()
    {
        ...
        // Set the initial best cost and trajectory
